 ...
 */
public class FourDotIndexEmbosserWriter implements ExtendedEmbosserWriter {
	...
	FourDotIndexEmbosserWriter(OutputStream os, BrailleConverter bc, byte[] header, EmbosserWriterProperties props) {
		this.props = props;
